...
int main(int argc, char **argv) {
    ...
    try {
        ...
        if (arguments["method"].value.asString == "monte-carlo"s) {
            ...
            throw string("Unknown sampling method: '"s + arguments["method"].value.asString + "'"s);
        }
        ...
        if (arguments["filtering"].value.asString == "linear"s) {
            ...
            throw string("Unknown filtering: '"s + arguments["filtering"].value.asString + "'"s);
        }
        ...
        cout << e << endl;
        cout << "Usage: encode " << cliInput.brief(16, 4) << endl;
        cout << cliInput.summary();
    }
